  ...
  */
  ...
  return (
    <div className="App">
      ...
      <Main isLeaderboardHidden = {isLeaderboardHidden} toggleLeaderboard = {() => setIsLeaderboardHidden(!isLeaderboardHidden)} isOverlayHidden = {isOverlayHidden} toggleOverlay = {() => setIsOverlayHidden(!isOverlayHidden)} setIsOverlayHidden = {setIsOverlayHidden} setIsLeaderboardHidden = {setIsLeaderboardHidden}></Main>
